    ...
    public partial class setings : Form
    {
        ...
        public void save_set()
        {
            ...
            using (XmlWriter writer = XmlWriter.Create("Settings.xml", settings))
            {
                ...
                writer.WriteElementString("pause_sec_dep", nastr.pause_sec_depth);
        ...
        private void стартToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            timer4.Interval = 1000*(int)numericUpDown3.Value;
            nastr.pause_sec_depth = (timer4.Interval).ToString();
